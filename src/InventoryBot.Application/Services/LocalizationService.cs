...
public class LocalizationService
{
    private static readonly Dictionary<string, Dictionary<string, string>> _resources = new()
    {
        ["uz"] = new()
        {
            ...
            ["WelcomeWithRoles"] = "Salom {0}!\nSizda quyidagi huquqlar bor: {1}",
            ...
            ["EnterExistingPassword"] = "Admin parolini kiriting:",
            ["YourRole"] = "Sizning rolingiz: {0}",
            ["Role_User"] = "Oddiy foydalanuvchi",
            ["Role_Storekeeper"] = "Omborchi",
            ["Role_Deputy"] = "O'rinbosar",
            ...
            ["Menu_Roles"] = "👤 Rollarni boshqarish",
            ["Btn_Add"] = "Qo'shish",
            ["Btn_List"] = "Ro'yxat",
            ["Btn_Back"] = "🔙 Ortga",
            ["Title_ManageWarehouses"] = "Omborlar boshqaruvi:",
            ["Title_ManageCustomers"] = "Xaridorlar boshqaruvi:",
            ["SelectUserForRole"] = "Rol beriladigan foydalanuvchini tanlang:",
        ...
        ["ru"] = new()
        {
            ...
            ["WelcomeWithRoles"] = "Здравствуйте, {0}!\nУ вас есть следующие права: {1}",
            ...
            ["Menu_Roles"] = "👤 Управление ролями",
            ["Btn_Add"] = "Добавить",
            ["Btn_List"] = "Список",
            ["Btn_Back"] = "🔙 Назад",
            ["Title_ManageWarehouses"] = "Управление складами:",
            ["Title_ManageCustomers"] = "Управление клиентами:",
            ["SelectUserForRole"] = "Выберите пользователя для назначения роли:",
        ...
        ["en"] = new()
        {
            ...
            ["WelcomeWithRoles"] = "Hi {0}!\nYou have the following permissions: {1}",
